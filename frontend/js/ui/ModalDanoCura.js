...
class ModalDanoCura {
    ...
    // ✅ CORRIGIDO: usa aplicarDanoEmMassa() e aplicarCuraEmMassa()
    //    que são os métodos reais do DanoCuraService
    // ─────────────────────────────────────────
    ...
    async aplicar() {
        try {
            ...
            // ✅ Usa validarEntrada() do próprio DanoCuraService (SRP)
            ...
            // ✅ CORRIGIDO: chama os métodos reais do DanoCuraService
            if (tipo === 'dano') {

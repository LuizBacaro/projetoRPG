/**
 * Pedidos de acesso às campanhas (visão do mestre) — dashboard GURPS.
 *
...
(function (global) {
    ...
    function getServico() {
        return new global.GurpsCampanhaService();
    }
    ...
    function atualizarBadge() {
        const badge = document.getElementById('gurpsPedidosBadge');
        if (!badge) return;
    ...
    function atualizarFiltrosUi() {
        document.querySelectorAll('[data-gurps-pedidos-filtro]').forEach((b) => {
            b.classList.toggle(
                'active',
                b.getAttribute('data-gurps-pedidos-filtro') === filtro
            );
        });
    }

    function renderLista() {
        const host = document.getElementById('gurpsPedidosLista');
        if (!host) return;
    ...
    function bindListenersUmaVez() {
        ...
        document.querySelectorAll('[data-gurps-pedidos-filtro]').forEach((b) => {
            b.addEventListener('click', () => void aplicarFiltro(b.getAttribute('data-gurps-pedidos-filtro')));
        });
        document
            .getElementById('gurpsPedidosRecarregar')

# Fase C: Janela de execução staging (rascunho inicial)

Baseado em: `docs/fase-c-janela-execucao-template.md`

## Metadados da janela

- Data: `2026-04-27`
- Horário início (UTC-3): `<09:30>`
- Horário fim previsto (UTC-3): `<10:30>`
- Ambiente: `staging`
- Executor técnico: `Luiz` (confirmar)
...
```bash
export STAGING_DB_URL="<postgresql://usuario:senha@host:5432/database>"
export BACKUP_FILE="staging_pre_fase_c_20260427_<HHMM>.dump"
```

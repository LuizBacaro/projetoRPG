...
from ..services.magia_service import DOMINIOS_FIXOS


# Tendencias aceitas (mesma grafia usada no catalogo oficial)
TENDENCIAS_VALIDAS = {
    "Leal e Bom",
    "Neutro e Bom",
    "Caotico e Bom",
...
class DivindadeCustomService:
    ...
    def listar_catalogo_unificado(self) -> List[Dict[str, Any]]:
        ...
        # Evita duplicata: customizada com mesmo nome do oficial nao entra
        filtradas_custom = [
    ...
    def criar(
        ...
        # Conflito com customizada existente (case-insensitive)
    ...
    def _dominios_permitidos_canonicos(self) -> Dict[str, str]:
        ...
        from ..core.divindades_catalogo import _key  # import tardio

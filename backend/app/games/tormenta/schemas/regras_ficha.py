...
class TormentaBestiarioAtaqueItem(BaseModel):
    ...
    critico: Optional[str] = Field(default=None, max_length=40)
...
class TormentaBestiarioResumoItem(BaseModel):
    ...
    slug: str = Field(..., max_length=80)
    nome: str = Field(..., max_length=200)
    nd: Optional[float] = Field(default=None, ge=0, le=50)
    nd_rotulo: Optional[str] = Field(default=None, max_length=16)
    tipo_criatura: Optional[str] = Field(default=None, max_length=80)
    grupo: Optional[str] = Field(default=None, max_length=80)
...
class TormentaBestiarioDetalheResponse(BaseModel):
    ...
    atributos_nulos: List[str] = Field(default_factory=list)

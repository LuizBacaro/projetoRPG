"""Repository do módulo Grimório (D&D 3.5).

Localização: `app.games.dnd35.repositories.grimorio_repository`. Shim em
`app.repositories.grimorio_repository` durante a reorganização multi-jogo.
"""

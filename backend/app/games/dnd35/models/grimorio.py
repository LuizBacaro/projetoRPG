...
class GrimorioMagia(Base):
    ...
    __table_args__ = (
        UniqueConstraint("combatente_id", "magia_id", "classe", name="uq_grimorio_combatente_magia_classe"),
...
class GrimorioHistoricoTroca(Base):
    ...
    magia_adicionada = relationship("Magia", foreign_keys=[magia_adicionada_id], lazy="joined")

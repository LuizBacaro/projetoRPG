...
class Combatente(SoftDeleteMixin, Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "hp_atual <= hp_maximo", name="ck_combatentes_hp_atual_lte_hp_maximo"
        ),
        CheckConstraint(
            "tipo IN ('jogador', 'monstro', 'npc')", name="ck_combatentes_tipo_valido"
        ),
    ...
    def esta_critico(self) -> bool:
        return 0 < self.hp_atual < self.hp_maximo * 0.25

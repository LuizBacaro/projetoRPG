"""
Service para leitura do catálogo de tabelas de classes (somente leitura) — D&D 3.5.

Localização: `app.games.dnd35.services.tabelas_classes_service`. Shim em
`app.services.tabelas_classes_service` durante a reorganização multi-jogo.
"""
...
from app.games.dnd35.catalogs.classes_tables_catalog import load_classes_tables_catalog

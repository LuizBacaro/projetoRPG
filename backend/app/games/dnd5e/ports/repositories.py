"""Contrato estrutural (Protocol) para o repositório de personagens D&D 5e."""
...
class Dnd5ePersonagemRepositoryProtocol(Protocol):
    """Superfície usada por `Dnd5ePersonagemService`."""

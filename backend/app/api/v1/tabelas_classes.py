"""
Endpoints read-only do catálogo de tabelas de classes (experimental).
"""
...
from app.schemas.tabelas_classes import TabelaClassesResponse, TabelasClassesListResponse

...
from ...core.deps import requer_mestre_ou_admin
from ...core.dependencies import get_campanha_service
from ...core.dependencies import get_sessao_campanha_service
from ...exceptions.custom_exceptions import ArenaBaseException
from ...schemas.campanha import CampanhaCreate, CampanhaResponse, CampanhaUpdate
from ...services.campanha_service import CampanhaService
from ...schemas.sessao_campanha import (
...
@router.post("/sessoes", response_model=SessaoCampanhaResponse, status_code=status.HTTP_201_CREATED)

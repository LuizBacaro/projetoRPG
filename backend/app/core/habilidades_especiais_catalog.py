"""
Loader do catálogo canônico de habilidades especiais.
...
- Resolver o caminho do artefato considerando layouts de deploy (Render/Vercel).
- Carregar e cachear em memória (`lru_cache`).
- Expor helpers de busca por slug, por título ou normalização textual.

Compatível com o padrão de `racas_catalog.py` para coerência entre catálogos.
"""

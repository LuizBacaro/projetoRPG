...
-- Data: 2026-04-12
-- Uso: psql $NEON_DATABASE_URL -f reconcile_alembic_neon.sql
-- ============================================================================

-- PRE-CHECK: Ver estado atual
SELECT '=== ANTES ===' AS checkpoint;
SELECT COUNT(*) AS total_hashes_registrados FROM public.alembic_version;
SELECT version_num FROM public.alembic_version ORDER BY version_num;

-- ============================================================================
-- INSERCOES IDEMPOTENTES - 14 hashes pendentes
-- ============================================================================
...
-- ============================================================================
SELECT '=== DEPOIS ===' AS checkpoint;
SELECT COUNT(*) AS total_hashes_registrados FROM public.alembic_version;
SELECT version_num FROM public.alembic_version ORDER BY version_num;

-- Verificar duplicatas (deverá retornar vazio)
SELECT '=== VALIDACAO INTEGRIDADE ===' AS checkpoint;
